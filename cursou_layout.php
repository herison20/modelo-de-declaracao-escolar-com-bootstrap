...
<div class="container bloco-declaracao ">
    ...
    <div class="row">
        <h3 class="text-center" id="titulo"> <b>DECLARAÇÃO</b> </h3>
        <p class="paragrafo">Declaramos, para os devidos fins, que <span style="font-weight:600">HÉRISON ROQUE DE ASSUNÇÃO</span>, CPF 000.000.000-65, RG 0000000-0, matrícula <spam style="font-weight: 600">135465461464</spam>, aluno(a) desta Instituição de Ensino, cursou o 4º Périodo  do Curso de <span style="font-weight: 600">CIÊNCIA DA COMPUTAÇÃO</span>, turno <span style="font-weight: 600">Noturno.</span></p>
